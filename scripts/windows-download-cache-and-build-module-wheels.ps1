...
$env:Path += ";C:\P\grep"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/InsightSoftwareConsortium/ITKPythonPackage/master/scripts/windows_build_module_wheels.py" -OutFile "C:\P\IPP\scripts\windows_build_module_wheels.py"
C:\Python35-x64\python.exe C:\P\IPP\scripts\windows_build_module_wheels.py $args
